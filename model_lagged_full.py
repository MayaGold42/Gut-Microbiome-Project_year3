...
classification_results_path = DATA_DIR / "full_fme_classification_model_comparison.csv"
...
plt.tight_layout()
plt.savefig(DATA_DIR / "full_fme_classification_model_performance.png", dpi=300, bbox_inches="tight")
plt.show()
